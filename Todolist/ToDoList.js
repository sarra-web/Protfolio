...
//Constructiond'unobjetJSON
var album={}
//Remplissagedel'objet
album.artiste='Carola';
album.titre='Idennanattblirvarldenny';
album.annee='2007';
album.chansons=[ {"titre":"Stillanatt,heliganatt"}, {"titre":"Lysstillanglasangensord"}, {"titre":"Glansoversjoochstrand"}, {"titre"
:"Idennanattblirvarldenny"} ];
//Onplacel'objetenmémoireentransformantleJSONenchainedecaracteres
localStorage.album=JSON.stringify(album);
//Pourlerecuperer,ontransformelachaineenJSON
